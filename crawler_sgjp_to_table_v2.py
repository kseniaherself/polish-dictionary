...
def M_create_table():
    ...
    f_name = 'sgjp_pages_1-1500000.tsv'
    ...
    for i in range(1, 5):   # переменные которые генерируются в M_create_files
        print(i)
...
# на случай двух p p
                ...
                if res_2:
                    ...
                    my_table_pp = my_table + n_l + my_url + t_s + str(i) + t_s + wordform + t_s + pp_tr
