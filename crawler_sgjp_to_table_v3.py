...
def M_create_table():
    ...
    f_name = 'sgjp_pages_368311-1500000.tsv'
    my_table = 'url' + t_s + 'id' + t_s + 'word_form' + t_s + 'p_pp_codes'
    F_write_file_w(my_table, f_name)
    error_file = open('errors_368311.txt','w')
    F_write_file_w('errors', 'error_368311.txt')

    for i in range(368311, 1500000):   # ПОДСТАВИТЬ НУЖНОЕ
        print(i)
